 ...
 *
 * @class M.mod_offlinequiz.dragdrop.section
 * @constructor
...
Y.extend(DRAGSECTION, M.core.dragdrop, {
    ...
    drop_hit: function(e) {
        ...
        Y.log("Moving from position " + dragnodeid + " to position " + dropnodeindex, 'debug', 'moodle-mod_offlinequiz-dragdrop');
                    ...
                    do {
                        ...
                        for (index = loopstart; index <= loopend; index++) {
                            if (Y.Moodle.core_course.util.section.getId(sectionlist.item(index - 1)) >
                                ...
                                M.mod_offlinequiz.edit.swap_sections(Y, index - 1, index);
    ...
    NAME: 'mod_offlinequiz-dragdrop-section',
    ATTRS: {
        courseid: {
            value: null
        },
