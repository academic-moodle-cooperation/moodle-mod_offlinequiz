...
(function() {
    ...
    function addScrollerDivs(tid,noOfCols) {
        ...
        sd2.innerHTML='<div id="' + tid + ':scroller:fx" style="text-align:left;position:relative;width:9999px;padding:0px;margin-left:0px;"><font size="3" color="red">Please wait whileasdfasdf..</font></div>';
        var fc=null;
        if(noOfCols > 0) {
...
//                    	c[q].style.width = c2[q].style.width=(oc[q].offsetWidth-3) + 'px';
                    	c[q].style.width = c2[q].style.width=($(oc[q]).width() - 3) + 'px';
                    }
                } else {
                    for(q=0;q<c.length;q++) {
                    	console.log(oc[q]);
//                    	c[q].style.width=(oc[q].offsetWidth-3) + 'px';
                    	c[q].style.width=($(oc[q]).width() - 3) + 'px';
                    	console.log(c[q]);
                    }
                }
