...
namespace mod_offlinequiz\form;
...
class add_random_form extends moodleform {
    ...
    protected function definition() {
        ...
        $previewhtml = $OUTPUT->render_from_template('mod_offlinequiz/random_question_form_preview', []);
        ...
        $PAGE->requires->js_call_amd('mod_offlinequiz/add_random_form', 'init', [
