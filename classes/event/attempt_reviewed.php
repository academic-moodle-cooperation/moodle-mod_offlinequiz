...
class attempt_reviewed extends \core\event\base {
    ...
    public function get_url() {
        return new \moodle_url('/mod/offlinequiz/review.php', array('resultid' => $this->objectid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'offlinequiz', 'review', 'review.php?attempt=' . $this->objectid,
