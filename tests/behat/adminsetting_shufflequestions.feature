...
Feature: Within a moodle instance, an administrator should be able to set the value for "Shuffle questions" for the entire Moodle installation.
  ...
  @javascript
  Scenario: Switch as an admin to the adminsettings of the module offlinequiz and change the value of "Shuffle questions". Then login as a teacher and add a new offline quiz to a course and check whether the default value has changed.
    Given I log in as "admin"
    And I navigate to "Plugins > Activity modules > Offline Quiz" in site administration
    And I set the field "Shuffle questions" to "Yes"
