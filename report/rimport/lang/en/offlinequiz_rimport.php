...
$string['errorfilenotimage'] = 'File is not an image or the PDF doesn\'t contain an image.';
...
$string['errorinvalidlistnumber'] = 'Invalid list number';
...
$string['pluginname'] = 'Offline Quiz Results Import';
...
$string['scanerrorlistnumber'] = 'The listnumber seems to be out of range. Please check the scanned document for barcode irregularities for the list number code (bottom right corner) and scan again with higher resolution if necessary!';
