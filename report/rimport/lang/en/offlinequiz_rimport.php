...
$string['scanerrorlistnumber'] = 'The listnumber seems to be out of range. Pleae check the scanned document for barcode irregularities for the listnumber code (bottom right corner) and scan again with higher resolution if necessary!';
