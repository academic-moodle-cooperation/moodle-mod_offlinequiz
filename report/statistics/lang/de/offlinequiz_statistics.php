...
$string['allgroups'] = 'Statistik für alle Offline-Test Gruppen';
...
$string['backtoofflinequizreport'] = 'Zurück zur Hauptseite Statistik';
...
$string['differentsumgrades'] = 'Anmerkung: Ihre Offline-Test Gruppen haben unterschiedliche maximale Bewertungen ({$a}). Deshalb können die Werte "Durchschnittsergebnis", "Median" und "Standardabweichung" nicht berechnet werden.';
