...
$string['eventleaderboardviewed'] = 'Offline quiz leaderboard viewed';
...
$string['nocm'] = 'This offlinequiz has no course module entry';
...
$string['privacy:metadata:offlinequiz:experimentalevaluation'] = 'If experimental evaluation is turned on for this offlinequiz';
...
$string['privacy:metadata:offlinequiz:pdffont'] = 'The PDF Font that is used to create the offlinequiz pdfs';
...
$string['tutorial:alt:checkboxlight'] = 'Lightly crossed box';
$string['tutorial:alt:checkboxmarked'] = 'Marked checkbox';
$string['tutorial:alt:questionaire'] = 'A question sheet';
...
$string['leaderboardanonymous'] = 'Enabled (anonymous ranking)';
$string['leaderboarddisabled'] = 'Disabled';
$string['leaderboardname'] = 'Name';
$string['leaderboardnoresults'] = 'No results are available yet.';
$string['leaderboardnotavailable'] = 'The leaderboard is not enabled for this quiz.';
$string['leaderboardpercent'] = 'Percentage';
$string['leaderboardallcohorts'] = 'All cohorts';
$string['leaderboardcohort'] = 'Cohort';
$string['leaderboardfilterby'] = 'Filter by';
$string['leaderboardrank'] = 'Rank';
$string['leaderboardresetfilter'] = 'Show all';
$string['leaderboarduserkey'] = 'Student ID (from paper)';
$string['leaderboardscore'] = 'Score';
$string['leaderboardwithnames'] = 'Enabled (show student names)';
$string['leaderboardyou'] = 'You';
$string['showleaderboard'] = 'Show leaderboard';
$string['showleaderboard_help'] = 'Controls whether enrolled users can view a ranking of all scores for this quiz. "With names" shows each student\'s full name. "Anonymous" only reveals the current student\'s own position; all other entries are shown without a name.';
$string['viewleaderboard'] = 'View leaderboard &amp; statistics';
$string['leaderboardtabstatistics'] = 'Statistics';
$string['leaderboardtabmycopy'] = 'My copy';
$string['leaderboardstatsparticipants'] = 'Participants';
$string['leaderboardstatsavg'] = 'Average';
$string['leaderboardstatsmedian'] = 'Median';
$string['leaderboardstatsstddev'] = 'Std. deviation';
$string['leaderboardstatsmin'] = 'Minimum';
$string['leaderboardstatsmax'] = 'Maximum';
$string['leaderboardstatspassrate'] = 'Pass rate (≥ 50%)';
$string['leaderboardstatsscoredistribution'] = 'Score distribution';
$string['leaderboardstatsquestions'] = 'Success rate by question';
$string['leaderboardstatscorrect'] = 'Correct';
$string['leaderboardstatspartial'] = 'Partial';
$string['leaderboardstatswrong'] = 'Wrong';
$string['leaderboardstatsstudents'] = 'Students';
$string['leaderboardstatscohorts'] = 'Average score by cohort (%)';
$string['leaderboardstatsavgscore'] = 'Average (%)';
$string['leaderboardstatsqnum'] = 'Question';
$string['leaderboardstatsqtotal'] = 'Submissions';
$string['leaderboardstatsnoresult'] = 'Your paper has not been processed yet.';
$string['leaderboardstatsviewcopy'] = 'View my copy';
$string['leaderboardmyscore']             = 'My score';
$string['leaderboardmyrank']              = 'My rank';
$string['leaderboardmypercentile']        = 'Top percentile';
$string['leaderboardmyresult']            = 'Result';
$string['leaderboardmypass']              = 'PASS';
$string['leaderboardmyfail']              = 'FAIL';
$string['leaderboardmyquestionbreakdown'] = 'My answers vs. class average';
$string['leaderboardmyresultcol']         = 'My answer';
$string['leaderboardclassavg']            = 'Class avg.';
$string['leaderboardreviewnotavailable']  = 'The detailed review is not available for this quiz.';
