...
$string['csvformat'] = 'Comma separated values (CSV) text file';
$string['csvplus1format'] = 'CSV text file (raw data)';
$string['csvpluspointsformat'] = 'CSV text file with points (raw data)';
...
$string['excelformat'] = 'Excel spreadsheet';
...
$string['odsformat'] = 'OpenDocument spreadsheet';
