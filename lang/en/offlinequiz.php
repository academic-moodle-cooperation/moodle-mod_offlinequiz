...
$string['addarandomselectedquestion'] = 'Add a randomly selected question ...';
...
$string['answerforms'] = 'Answer forms';
...
$string['cannotreview'] = 'You are not allowed to view this report.';
...
$string['closestudentview'] = 'Close report view';
$string['closewindow'] = 'Close window';
$string['cmmissing'] = 'The course module for the offline quiz with ID {$a} is missing';
$string['completiondetail:passgrade'] = 'Receive a passing grade';
$string['completionpass'] = 'Pass to complete';
$string['completionpass_help'] = 'Students only complete this offline quiz, if they reach a grade higher than or equal to the passing grade set in the grade options';
$string['configblackwhitethreshold'] = 'Sets the threshold for the black/white converting between 1-99 - The higher the value, the more white the imported pixel needs to be, in order to be recognized as white. Any other value leads to no black/white conversion at all.';
$string['configdecimalplaces'] = 'Number of digits to be shown after the decimal point when displaying grades for the offline quiz.';
$string['configdisableimgnewlines'] = 'This option disables new lines before and after images and equations in the pdf question forms. Warning: This might lead to formatting problems.';
$string['configexperimentalevaluation'] = 'Experimental evaluation of answer forms';
$string['configexperimentalevaluationdesc'] = 'DO NOT USE IN PRODUCTION! This option is used for alpha tests of the new evaluation algorithm. If this option is activated, the experimental evaluation can be enabled the settings of the offline quiz instance. We highly discourage use of this setting. There is no support at all for lost data if this setting is activated.';
$string['configintro'] = 'The values set here are used as default values for the settings of new offline quizzes.';
...
$string['configmaximumgrade'] = 'The default grade after which the offline quiz grade is scaled.';
$string['configonlylocalcategories'] = 'No shared question categories allowed.';
$string['configpapergray'] = 'White-value of paper, which is used for the evaluation of answer forms';
$string['configshufflequestions'] = 'If this setting is enabled, then the order of questions in the offline quiz groups will be randomly shuffled each time you re-create the preview in the "Create forms" tab.';
$string['configshufflewithin'] = 'If this setting is enabled, the answers of multiple choice questions are shuffled separately for each offline quiz group.';
...
$string['correctbutton'] = 'Correct ({$a})';
...
<ul>
  ...
  <li><strong>Pages incomplete:</strong> The current answer form has been evaluated, but at least 1 additional form is missing to complete the evaluation for the identified participant. (Only occurs with multi-page answer forms.)</li>
...
$string['discriminationindex_info'] = 'Since the discrimination index calculates a prediction of the question between good and inferior grades, it cannot be calculated if either
- there are no different responses of the students in this question
- there are no different grades in the exam';
$string['displayoptions'] = 'Display options';
$string['documentschanged'] = 'One ore more question(s) in the offline quiz was/ were changed since creating the documents.<br>Future results will be regraded automatically during the evaluation to the current version of the question(s) chosen here. The original version of the question(s) is still shown in the documents.';
$string['documentschangedwithresults'] = 'One ore more question(s) in the offline quiz was/ were changed since creating the documents.<br>Existing results were regraded automatically to the current version of the question(s) chosen here. The original version of the question(s) is still shown in the documents.';
...
$string['errorcouldnotcreatetex'] = 'Coud not create image file for LaTeX equation';
$string['errormultiuserinlist'] = 'User is listed more than once in the attendance lists!';
...
$string['experimentalevaluation'] = 'Experimental evaluation of answer forms';
$string['experimentalevaluation_help'] = 'Experimental evaluation of answer forms';
$string['fileformat'] = 'Format for question forms';
$string['fileformat_help'] = 'Choose whether you want your question forms in PDF, DOCX or TEX format. Answer forms and correction forms will always be generated in PDF format.';
...
$string['instruction2'] = 'Only clear markings can be interpreted correctly! If you want to correct a marking, completely fill out the box with color. This field will be interpreted as an empty box:';
...
$string['invalidgroupnumber'] = 'Invalid group number';
$string['invalidnumberofdigits'] = 'Invalid number of digits used. Only 1 up to 9 digit(s) are allowed.';
$string['invalidofflinequizid'] = 'Invalid offline quiz ID';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'Image file that is displayed on the top right corner of answer forms. The maximum allowed size is 520x140 pixels. Answer forms cannot be evaluated if the image exceeds the maximum size!';
...
$string['marginwarning'] = 'Please print out the following PDF files without additional margins!<br /> Avoid handing out photocopies to students.';
$string['marks'] = 'Marks';
...
* Supported question types: multiple choice, description, and all-or-nothing multiple choice.
* Up to six exam groups are possible. * Exam forms are automatically generated by the system.
* Questionnaire formats: PDF, DOCX, LaTeX. * Answer sheets: standardized PDFs.
* Participants mark their answers on printed answer sheets.
* Completed answer sheets are scanned as TIFF, PDF, PNG, or JPG files, uploaded in the offline quiz, and automatically graded.
* Sheets with recognition errors can be manually corrected online.
* Online access to exam results is available.
* Attendance lists can be generated as needed.

###### Application Scenarios
* Large presence exams with a high number of participants, especially when results are needed quickly.';
$string['modulename_summary'] = 'This module is used to generate multiple-choice quizzes in Moodle, which are administered in printed form in the lecture hall. The completed answer sheets are scanned, uploaded to the offline quiz, and automatically graded.';
$string['modulename_tip'] = '<p><a href="https://academic-moodle-cooperation.org/anleitungen/offline-test-einstellungen/?lng=en" target="_blank"><i class="icon fa fa-info-circle"></i>Guide: "Offline quiz: settings"</a></p>
<p><a href="https://academic-moodle-cooperation.org/anleitungen/offline-test-fragen-hinzufugen-und-formulare-generieren/?lng=en" target="_blank"><i class="icon fa fa-info-circle"></i>Guide: "Offline quiz: add questions and generate forms"</a></p>
<p><a href="https://academic-moodle-cooperation.org/anleitungen/offline-test-durchfuhren-und-auswerten/?lng=en" target="_blank"><i class="icon fa fa-info-circle"></i>Guide: "Conduct and evaluate offline quiz"</a></p>
<p><a href="https://academic-moodle-cooperation.org/anleitungen/offline-test-anwesenheitslisten-erstellen-und-nutzen/?lng=en" target="_blank"><i class="icon fa fa-info-circle"></i>Guide: "Offline quiz: create and use attendance lists"</a></p>';
...
$string['noaccess'] = 'You have no access to this attempt.';
...
$string['nocm'] = 'This offline quiz has no course module entry';
...
$string['nogroups'] = 'No groups created for this offline quiz';
...
$string['nopage'] = 'No page parameter set';
...
$string['offlinequiz:changeevaluationmode'] = 'Make it possible to change the evaluation mode. WARNING: DO NOT USE IN PRODUCTION SYSTEMS!';
...
$string['offlinequizwillopen'] = 'Offline quiz opens on {$a}';
...
$string['pageevaluationtask'] = 'Answer forms evaluation for the offline quiz plugin';
$string['pageimported'] = 'Forms of participants list imported';
$string['pagenumberimported'] = 'Form {$a} of attendance list imported';
...
$string['participants_help'] = '<p>Attendance lists are designed for large offline quizzes with many participants. They help the teacher determine which students participated in the quiz and whether all the results were imported correctly.
You can add users to different attendance lists. Each list could, for instance, contain the participants in a particular room. Or the participants may be members of a specific group. A group registration tool can be used for creating those groups.
Attendance lists may be downloaded as PDF documents, printed and marked with crosses just like the answer forms. Afterwards, they can be uploaded and the marked students will be marked as present in the database.
...
Here you can upload the filled-out attendance lists. You can upload single scanned image files or several scanned image files in a ZIP-archive. The offline quiz module will process the image files in the background.
File names are not relevant but should not contain special characters such as umlauts. Images should be GIFs, PNGs
or TIFs. A resolution between 200 and 300dpi is recommended.</p>';
$string['pdffont'] = 'Form font';
$string['pdffont_help'] = 'Here you can choose a font for all your PDF forms: answer forms, correction forms, attendance forms. As well as question forms, if you choose a PDF format for it. The choice should also depend on which characters you use in your forms. With DOCX and LATEX format the question forms are not affected by it.';
$string['pdfintro'] = 'Additional information';
$string['pdfintro_help'] = 'This information will be printed on the first page of the question form and should contain general information about how to fill in the answer form.';
$string['pdfintrotext'] = '<b>How do I mark correctly?</b><br />This answer form will be scanned automatically. Please do not fold or spot. Use a black or blue pen to mark the fields. If you want to correct a marking, completely fill in the box with color. This field will be interpreted as an empty box.<br />';
...
$string['printstudycodefield'] = 'Print study code field on question form';
$string['printstudycodefield_help'] = 'If checked, the study code field will be printed on the first page of the question form.';
$string['privacy:data_folder_name'] = 'Offline quiz data';
$string['privacy:metadata:core_files'] = 'The offline quiz uses the file API to store the generated question, answer and correction forms, as well as the filled out answer forms.';
$string['privacy:metadata:core_question'] = 'The offline quiz uses the question API for saving the questions for the quizzes.';
$string['privacy:metadata:offlinequiz'] = 'The offline quiz table stores all information specific to an offline quiz instance.';
$string['privacy:metadata:offlinequiz:algorithmversion'] = 'The version of the evaluation algorithm';
$string['privacy:metadata:offlinequiz:completionpass'] = 'The ID of the completion element';
$string['privacy:metadata:offlinequiz:course'] = 'The \'course\' column in the offline quiz table stores the course this offline quiz is located in.';
$string['privacy:metadata:offlinequiz:decimalpoints'] = 'The amount of decimal points to calculate for the grades.';
$string['privacy:metadata:offlinequiz:disableimgnewlines'] = 'Should disable new lines before and after images and equations.';
$string['privacy:metadata:offlinequiz:docscreated'] = 'If the documents have been created, this field is set to 1, otherwise to 0.';
$string['privacy:metadata:offlinequiz:experimentalevaluation'] = 'If experimental evaluation is turned on for this offline quiz';
$string['privacy:metadata:offlinequiz:fileformat'] = 'The file format which is used to print the question forms, 0 for pdf, 1 for docx, 2 for LaTeX.';
$string['privacy:metadata:offlinequiz:fontsize'] = 'The size of the font in the questions heets.';
$string['privacy:metadata:offlinequiz:grade'] = 'The grade shows the maximum amount of points it is possible to score in this offline quiz.';
$string['privacy:metadata:offlinequiz:id_digits'] = 'Stores the amount of digits the ID number had when the answer forms were created. This is needed for backward compability if the amount is raised between creation and import of the answer sheets.';
$string['privacy:metadata:offlinequiz:intro'] = 'The intro of this offline quiz';
$string['privacy:metadata:offlinequiz:introformat'] = 'This field is not used.';
$string['privacy:metadata:offlinequiz:name'] = 'The \'name\' column stores the name of the offline quiz.';
$string['privacy:metadata:offlinequiz:numgroups'] = 'The amount of groups this offline quiz has.';
$string['privacy:metadata:offlinequiz:papergray'] = 'The white value of this offline quiz.';
$string['privacy:metadata:offlinequiz:pdffont'] = 'The font that is used to create the offline quiz PDF forms';
$string['privacy:metadata:offlinequiz:pdfintro'] = 'The additional information which is inserted into the question forms in the beginning.';
$string['privacy:metadata:offlinequiz:printstudycodefield'] = 'A preference whether the study code should be printed on the question form. 1 for true, 0 otherwise.';
$string['privacy:metadata:offlinequiz:review'] = 'This column stores information on how the review is done.';
$string['privacy:metadata:offlinequiz:showgrades'] = 'Stores whether the amount of maximum points for a question should be printed on the question form.';
$string['privacy:metadata:offlinequiz:showquestioninfo'] = 'Stores whether certain information about the questions should be displayed, 0 for no, 1 for information about question type, 2 for information about the amount of right answers.';
$string['privacy:metadata:offlinequiz:showtutorial'] = 'Stores whether participants should be asked to do an offline quiz tutorial.';
$string['privacy:metadata:offlinequiz:shufflequestions'] = 'A preference, whether the questions should be shuffled when creating an offline quiz; 1 for shuffling, 0 otherwise.';
$string['privacy:metadata:offlinequiz:time'] = 'The time column stores the date of the offline quiz.';
$string['privacy:metadata:offlinequiz:timeclose'] = 'The timeclose column stores when the offline quiz was/will be closed.';
$string['privacy:metadata:offlinequiz:timecreated'] = 'The timecreated column stores when the offline quiz was created.';
$string['privacy:metadata:offlinequiz:timemodified'] = 'The timemodified column stores the time when the offline quiz was changed the last time.';
$string['privacy:metadata:offlinequiz:timeopen'] = 'The timeopen column stores when an offline quiz was/will be opened.';
$string['privacy:metadata:offlinequiz_choices'] = 'This table holds the information of all the crosses for all the scanned pages. This information is needed to later create results based on the crosses.';
$string['privacy:metadata:offlinequiz_choices:choicenumber'] = 'The number of choices for this question.';
...
$string['privacy:metadata:offlinequiz_choices:value'] = 'Whether the choice is considered to be crossed out. 0 for no, 1 for yes, -1 for uncertain.';
$string['privacy:metadata:offlinequiz_group_questions'] = 'This table stores all the questions for every offline quiz group.';
$string['privacy:metadata:offlinequiz_group_questions:maxmark'] = 'The amount of maximum points for this question.';
$string['privacy:metadata:offlinequiz_group_questions:offlinegroupid'] = 'The offline quiz group this group question relates to.';
$string['privacy:metadata:offlinequiz_group_questions:offlinequizid'] = 'The offline quiz ID this group question relates to.';
$string['privacy:metadata:offlinequiz_group_questions:page'] = 'The page on which this question is printed in the answer forms.';
$string['privacy:metadata:offlinequiz_group_questions:position'] = 'The position in this offline quiz.';
...
$string['privacy:metadata:offlinequiz_groups'] = 'Table of the groups that are taking part in offline quizzes.';
$string['privacy:metadata:offlinequiz_groups:answerfilename'] = 'The file name which was used to save the answer file.';
$string['privacy:metadata:offlinequiz_groups:correctionfilename'] = 'The file which was used to save the correction file.';
$string['privacy:metadata:offlinequiz_groups:number'] = 'The group number of this offline quiz, 1 for group A, 2 group B, and so on.';
$string['privacy:metadata:offlinequiz_groups:numberofpages'] = 'The amount of pages needed to print the answer forms on.';
$string['privacy:metadata:offlinequiz_groups:offlinequizid'] = 'The ID of the offline quiz.';
$string['privacy:metadata:offlinequiz_groups:questionfilename'] = 'The file name which was used to save the question file';
...
$string['privacy:metadata:offlinequiz_hotspots'] = 'This table stores all the positions of the check boxes and whether they were evaluated successfully.';
$string['privacy:metadata:offlinequiz_hotspots:blank'] = 'Whether the hotspot is analyzed successfully.';
...
$string['privacy:metadata:offlinequiz_p_choices'] = 'This table stores all the crosses for the attendance lists.';
$string['privacy:metadata:offlinequiz_p_choices:scannedpageid'] = 'The scanned page this choice relates to.';
$string['privacy:metadata:offlinequiz_p_choices:userid'] = 'The user ID this choice relates to.';
$string['privacy:metadata:offlinequiz_p_choices:value'] = 'Whether the cross is filled out or not (0 for not filled out, 1 for filled out, -1 for insecure).';
$string['privacy:metadata:offlinequiz_p_lists'] = 'This table stores information about attendance lists where teachers can record whether a student was there or not.';
$string['privacy:metadata:offlinequiz_p_lists:filename'] = 'The name of the file for the list.';
$string['privacy:metadata:offlinequiz_p_lists:name'] = 'The name of the attendance list.';
$string['privacy:metadata:offlinequiz_p_lists:number'] = 'The number of the attendance list in the offline quiz.';
$string['privacy:metadata:offlinequiz_p_lists:offlinequizid'] = 'The offline quiz this attendance list belongs to.';
$string['privacy:metadata:offlinequiz_page_corners'] = 'This table stores all the corners for every scanned page to evaluate it faster for the next evaluation or correction.';
...
$string['privacy:metadata:offlinequiz_participants'] = 'The participants table stores whether the user was taking part in the offline quiz or not.';
$string['privacy:metadata:offlinequiz_participants:checked'] = 'The information whether this user was checked on the attendance list.';
$string['privacy:metadata:offlinequiz_participants:listid'] = 'The ID of the attendance list this participant is on.';
$string['privacy:metadata:offlinequiz_participants:userid'] = 'The user ID of the user.';
$string['privacy:metadata:offlinequiz_queue'] = 'This table stores a queue of an upload. For every upload there is an own object in this table.';
$string['privacy:metadata:offlinequiz_queue:importuserid'] = 'The user ID of the teacher who imported the files.';
$string['privacy:metadata:offlinequiz_queue:offlinequizid'] = 'The offline quiz ID of the queue.';
$string['privacy:metadata:offlinequiz_queue:status'] = 'The status of the queue which is needed.';
$string['privacy:metadata:offlinequiz_queue:timecreated'] = 'The time the forms of this offline quiz were imported.';
...
$string['privacy:metadata:offlinequiz_queue_data'] = 'This table stores data for the queue as every file in the queue will get a queue data object.';
$string['privacy:metadata:offlinequiz_queue_data:error'] = 'If the status shows an error, there will be a more detailed error message here.';
$string['privacy:metadata:offlinequiz_queue_data:filename'] = 'The file name of the file this queue relates to.';
...
$string['privacy:metadata:offlinequiz_results'] = 'This table stores all the result data, which is not storable in the quiz API.';
$string['privacy:metadata:offlinequiz_results:offlinegroupid'] = 'The offline quiz group which this result belongs to.';
$string['privacy:metadata:offlinequiz_results:offlinequizid'] = 'The offline quiz, which this result belongs to.';
...
$string['privacy:metadata:offlinequiz_results:userid'] = 'The user this result belongs to.';
$string['privacy:metadata:offlinequiz_scanned_p_pages'] = 'This table stores attendance pages and their general information.';
$string['privacy:metadata:offlinequiz_scanned_p_pages:error'] = 'The error (if present) this page triggered while processing.';
...
$string['privacy:metadata:offlinequiz_scanned_p_pages:offlinequizid'] = 'The offline quiz this attendance page belongs to.';
...
$string['privacy:metadata:offlinequiz_scanned_pages'] = 'This table stores information on a scanned page of an offline quiz.';
$string['privacy:metadata:offlinequiz_scanned_pages:error'] = 'The detailed error this page has (if present).';
$string['privacy:metadata:offlinequiz_scanned_pages:filename'] = 'The file name of the scanned page.';
$string['privacy:metadata:offlinequiz_scanned_pages:groupnumber'] = 'The group number of the group this offline quiz belongs to.';
$string['privacy:metadata:offlinequiz_scanned_pages:offlinequizid'] = 'The offline quiz of the scanned page.';
$string['privacy:metadata:offlinequiz_scanned_pages:pagenumber'] = 'The page number of this page.';
...
$string['privacy:metadata:offlinequiz_scanned_pages:userkey'] = 'The user key (not user ID) of the crossed out user on the page.';
$string['privacy:metadata:offlinequiz_scanned_pages:warningfilename'] = 'The file name of the file which is created when a wrongly filled in answer form is corrected and the user gets a warning about it.';
$string['privacy:metadata:offlinequizpagesize'] = 'Sets the number of entries for the results page.';
$string['qandabehaviourheader'] = 'Question and answer behaviour';
...
$string['questionsheet'] = 'Question form';
...
$string['qversionupdatedwarning'] = 'Forms were already created.<br>If results exist they were regraded automatically to the current version of the changed question chosen here. The original version of the question is still shown in the documents.';
...
$string['reallydeleteupdatepdf'] = 'Do you really want to delete and update the attendance list?';
...
**The attempt** - The text of the questions and answers will be shown to the students. They will see which answers they chose, but the correct answers will not be displayed.
...
**General feedback** - General feedback is displayed to the student after the results were imported. Unlike specific feedback, which depends on the question type and what response the student gave, the same general feedback text is shown to all students. You can use the general feedback to give students a fully worked out answer and perhaps a link to more information they can use if they did not understand the questions.

**Correct answers** - Correct and incorrect answers are displayed. This option is only available if "The attempt" is set.

**Scanned form** - The scanned answer forms are displayed. Checked boxes are marked with green squares.

**Scanned form with grades** - The scanned answer forms are displayed. Checked boxes are marked with green squares. Incorrect and missing marks are highlighted. Additionally, a table displays the maximum grade and the achieved grade for every question.';
$string['reviewoptionsheading'] = 'Review options';
$string['rotate'] = 'Rotate';
$string['rotatingsheet'] = 'Sheet is being rotated...';
$string['save'] = 'Save';
...
$string['showcopyrightdesc'] = 'If you enable this option, a copyright statement will be displayed on the student result review page.';
$string['showgrades'] = 'Print question grades';
$string['showgrades_help'] = 'This option controls whether the maximum grades of the offline quiz questions should be printed on the question form.';
...
$string['showquestioninfo_help'] = 'With this option you can control what additional information about the question is printed on the question form.
...
$string['showstudentview'] = 'Show report preview';
...
The tutorial provides information about how to use the different types of documents in offline quizzes. In an interactive part students learn how to tick their student ID correctly.<br />
<b>Please note:</b><br />
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time you press the reload button in the form preview. NOTE: This setting only applies to questions that have the shuffling option activated.';
...
$string['subplugintype_offlinequiz'] = 'Offline quiz report';
$string['subplugintype_offlinequiz_plural'] = 'Offline quiz reports';
...
$string['tutorial:alt:checkboxlight'] = 'Lightly marked checkbox';
$string['tutorial:alt:checkboxmarked'] = 'Marked checkbox';
$string['tutorial:alt:questionaire'] = 'A question form';
...
$string['tutorial:feedback:1:2'] = 'The layout of the question form doesn\'t have to look exactly the same as the one in the screenshot. It is only to show you the questions and it is not scanned in after the examination.';
...
$string['tutorial:feedback:2:3'] = 'A thick cross may be interpreted as having been corrected (filled in completely).';
...
$string['tutorial:header:1'] = '1. Question and answer forms';
...
$string['tutorial:introduction:1'] = 'In the examination you will receive two forms: one with the questions and one with boxes to mark your answers on. The questions are numbered and so are the boxes on the answer form. Each answer is marked with a letter. After the examination, the answer form is scanned and interpreted by a computer.';
$string['tutorial:introduction:2:1'] = 'The boxes on the answer form are 5 millimetres wide. The boxes belonging to the same question are in one row. The number of the question is on the left hand side and the letter corresponding to the answer item is at the top of the column.';
$string['tutorial:introduction:2:2'] = 'Use a black or blue pen to mark the fields. If you want to correct a mark, fill in the box completely. This field will then be interpreted as an empty box.';
$string['tutorial:introduction:3:1'] = 'The answer form contains a block for your name (A), a block for your identification number (B) and a block for the answers (C). Fill in the boxes for your name, signature and identification number first. Please note that the machine will not try to interpret your handwriting after the examination. These boxes are only for documentation purposes.';
...
$string['tutorial:introduction:5'] = 'Please keep in mind, that the answer forms are interpreted by a computer programme. It can\'t read anything you write next to the boxes. To the computer programme, anything outside the boxes is just a spot that prevents the machine from interpreting the form correctly. You are punishing yourself if you don\'t place the marks correctly.';
$string['tutorial:option:1:1'] = 'An answer form';
$string['tutorial:option:1:2'] = ' A question form';
...
$string['tutorial:questionsheet:1'] = '1)&nbsp;&nbsp; How many offline quiz documents will be given to you during an exam?';
...
$string['tutorial:questionsheet:2'] = '2)&nbsp;&nbsp; What content is available on a questionnaire of the offline quiz?';
...
$string['tutorial:start_text'] = 'This tutorial will show you the correct way of filling out the forms of an offline quiz and marking your answers for the automatic evaluation. We highly recommend you do the tutorial at least once, before having your first test or exam with an offline quiz.';
$string['tutorial:starttutorial'] = 'Start tutorial';
$string['tutorial:title'] = 'Tutorial';
$string['tutorial:title:navigation'] = 'Navigation';
$string['tutorialbutton'] = 'Start tutorial';
...
$string['viewresultbutton'] = 'View result';
$string['white'] = 'White';
