...
$string['documentschanged'] = 'Offlinequiz questions were changed since creating the documents.';
$string['documentschangedwithresults'] = 'Offlinequiz questions were changed since creating the documents. Grades are adapted to the questions provided here. The documents still have the unchanged questions.';
$string['done'] = 'done';
