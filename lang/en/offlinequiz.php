...
$string['createpdfforms'] = 'Create PDF forms';
...
$string['deletepdfs'] = 'Delete PDF forms';
...
$string['deleteupdatepdf'] = 'Delete and update PDF files';
...
$string['downloadpdfs'] = 'Download PDFs';
...
$string['formsexist'] = 'PDF forms already exist!';
...
$string['marginwarning'] = 'Please select one of these PDF files and print it without additional margins!<br />If you have any doubts order copies from the support team.';
$string['marks'] = 'Marks';
...
$string['nocourse'] = 'The course with id {$a->course} that the offlinequiz with ID {$a->offlinequiz} belongs to is missing.';
...
$string['noofflinequiz'] = 'There is no offlinequiz with id {$a}!';

$string['nopages'] = 'No pages imported';
$string['noparticipantsfound'] = 'No participants found';
$string['nopdfscreated'] = 'No PDF forms created';
$string['noquestions'] = 'Some offline groups do not contain any questions!';
...
$string['offlinequizisclosedwillopen'] = 'Quiz closed (opens {$a})';
$string['offlinequizisopenwillclose'] = 'Quiz open (closes {$a})';
...
$string['page-mod-offlinequiz-x'] = 'Any offlinequiz page';
$string['page-mod-offlinequiz-edit'] = 'Edit offlinequiz page';
...
$string['pdfintro_help'] = 'This information will be printed on the first page of the PDF question sheet and should contain general information about how to fill in the answer form.';
...
The text of the questions and answers will be shown to the students. They will see which answers they chose, but the correct answers will not indicated.</td>
</td></tr>
...
The grades (points) for the offlinequiz will be shown. This option is only usefull if responses or scanned form are set.
</td></tr>
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time you press the reload button in the form preview. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
