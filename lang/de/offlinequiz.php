...
$string['configuseridentification'] = 'Eine Formel, die die Identifikation von NutzerInnen beschreibt. Diese Formel wird verwendet, um hochgeladene Antwortbögen den richtigen NutzerInnen zuzuordnen. Dir rechte Seite der Gleichung muss ein Feld der user Tabelle von Moodle sein.';
$string['confirmremovequestion'] = 'Sind Sie sicher, dass die Frage des Typs {$a} entfernen wollen?';
