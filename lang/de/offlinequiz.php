...
$string['alllists'] = 'Alle Anwesenheitslisten';
...
$string['createpdfforms'] = 'PDFs erstellen';
$string['createpdf'] = 'PDF-Formular';
$string['createpdfs'] = 'PDFs herunterladen';
...
$string['deletepdfs'] = 'PDFs löschen';
...
$string['downloadpdfs'] = 'PDFs herunterladen';
...
$string['formsexist'] = 'PDF-Dateien bereits erstellt.';
...
$string['marginwarning'] = 'Bitte drucken Sie die folgenden Antwortbögen ohne zusätzliche Seitenränder.';
...
$string['realydeletepdfs'] = 'Möchten Sie die Fragebögen wirklich löschen?';
...
$string['reviewofattempt'] = 'Prüfungsprotokoll';
